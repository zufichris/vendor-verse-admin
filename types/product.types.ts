...
export const ProductStatusSchema = z.enum(["active", "inactive", "draft", "archived", "deleted"])
...
export const ProductTypeSchema = z.enum(["simple", "configurable", "virtual", "downloadable"])
...
export const ProductSchema = z
  ...
  .superRefine((data: any, ctx: any) => {
    ...
    if (
      ...
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message: "Virtual/Downloadable products should not have weight or dimensions.",
...
export const BannerSchema = z.object({
  ...
  image: z.string().optional().describe("banner image"),
