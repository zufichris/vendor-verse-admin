...
import { Calendar, CreditCard, DollarSign, Edit, FileText, MapPin, Package } from 'lucide-react'
              ...
              {order.fulfillmentStatus === 'shipped' && (
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">{formatDate(order.updatedAt || new Date().toISOString())}</p>
                  </div>
                </div>
              )}
